...
import com.apixio.model.patientdataset.{EngineVariantMetaData, ProjectDataSetState}
import com.fasterxml.jackson.annotation.{JsonIgnoreProperties, JsonProperty}

@JsonIgnoreProperties(ignoreUnknown = true)
case class SummaryReportV2(@JsonProperty("projectDataSetUuid")              projectDataSetUuid: String,
