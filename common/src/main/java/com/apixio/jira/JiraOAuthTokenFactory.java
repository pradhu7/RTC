...
class JiraOAuthTokenFactory {
    ...
    JiraOAuthTokenFactory(String jiraBaseUrl) {
     ...
     */
    JiraOAuthGetAccessToken getJiraOAuthGetAccessToken(String tmpToken, String secret, String consumerKey, String privateKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
     ...
     * @throws InvalidKeySpecException
     */
    JiraOAuthGetTemporaryToken getTemporaryToken(String consumerKey, String privateKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
