...
/**
 * The PollableAsyncAppender lets users log events asynchronously.
 * <p/>
 * <p/>
 * The PollableAsyncAppender will collect the events sent to it and then dispatch them
 * to all the appenders that are attached to it. You can attach multiple
 * appenders to an PollableAsyncAppender.
 * </p>
 * <p/>
 * <p/>
 * The PollableAsyncAppender uses a separate thread to serve the events in its buffer.
 * </p>
 * <p/>
 * <b>Important note:</b> The <code>PollableAsyncAppender</code> can only be script
 * configured using the {@link org.apache.log4j.xml.DOMConfigurator}.
 * <b>HACKED FROM ASYNCAPPENDER TO BE CHECKABLE
 * </p>
 *
 ...
 * @since 0.9.1
 */
public class PollableAsyncAppender extends AppenderSkeleton
  ...
  public PollableAsyncAppender() {
    ...
    dispatcher.setName("PollableAsyncAppender-Dispatcher-" + dispatcher.getName());
    dispatcher.start();
  }
  ...
  /**
   * Find current size of buffer list.
   * 
   * @return
   */
  ...
  /**
   * Close this <code>PollableAsyncAppender</code> by interrupting the dispatcher
  ...
  private static final class DiscardSummary {
    ...
    public LoggingEvent createEvent() {
      ...
      return new LoggingEvent(
              "org.apache.log4j.PollableAsyncAppender.DONT_REPORT_LOCATION",
  ...
  private static class Dispatcher implements Runnable {
    /**
     * Parent PollableAsyncAppender.
     */
    private final PollableAsyncAppender parent;
     ...
     *
     * @param parent     parent PollableAsyncAppender, may not be null.
     ...
     */
    public Dispatcher(
      final PollableAsyncAppender parent, final List buffer, final Map discardMap,
    ...
    public void run() {
      ...
      try {
        //
        //   loop until the PollableAsyncAppender is closed.
        //
        while (isActive) {
