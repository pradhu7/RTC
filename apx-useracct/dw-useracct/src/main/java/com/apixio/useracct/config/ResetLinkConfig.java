...
/**
 * Contains the yaml-poked reset password link related configuration:
 *
...
public class ResetLinkConfig {
    ...
    {
        return ("ResetLinkConfig:  linkTimeout=" + linkTimeout +
                "; urlBase=" + urlBase
            );
    }
