...
/**
 * May 2019:  copied from https://github.com/BetterCloud/vault-java-driver/blob/master/src/main/java/com/bettercloud/vault/SslConfig.java
 * and modified to remove lombok traces.
...
public class SslConfig implements Serializable {
    ...
    /**
     * Added to replace lombok functionality
     */
    ...
    protected void setPemUTF8(String pem)
    {
        this.pemUTF8 = pem;
    }
