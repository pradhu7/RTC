 ...
 */
public class NewHicNumber implements HICN {
    ...
    private URI uri;
    private URI medicarePlanURI;
    private DateRange dateRange;

    public NewHicNumber() {
        this.xuuid = XUUID.create("HICN");
    }
    ...
    @Override
    public URI getMedicarePlanURI() {
        return this.medicarePlanURI;
    }

    @Override
    public void setMedicarePlanURI(URI newMedicarePlanURI) {
        this.medicarePlanURI = newMedicarePlanURI;
    }

    @Override
    public DateRange getTimeBoundIdentifierDateRange() {
        return this.dateRange;
    }

    @Override
    public void setTimeBoundIdentifierDateRange(DateRange newTimeBoundIdentifierDateRange) {
        this.dateRange = newTimeBoundIdentifierDateRange;
    }
}
