 ...
 */
public class NewFamilyHistory implements FamilyHistory {
    private XUUID xuuid;
    ...
    public NewFamilyHistory() {
        this.xuuid = XUUID.create("NewFamilyHistory");
    }

    @Override
    public String getFamilyHistoryValue() {
        return this.value;
    }

    @Override
    public void setFamilyHistoryValue(String newFamilyHistoryValue) {
        this.value = newFamilyHistoryValue;
    }
