 ...
 */
public class ComboUserGroupDaoFactory extends BaseUserGroupDaoFactory implements UserGroupDaoFactory
{

    public UserGroupDao getDefaultUserGroupDao(DaoBase base, String cfName)
    {
        return new ComboUserGroupDao(base, DEFAULT_KEY_PFX, cfName);
    }
    ...
    public UserGroupDao getExtendedUserGroupDao(DaoBase base, int extensionNum, String cfName)
    {
        ...
        return new ComboUserGroupDao(base, EXTENDED_DAO_KEYS[extensionNum], cfName);
    }
