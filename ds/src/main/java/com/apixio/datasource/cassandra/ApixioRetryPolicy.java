...
public class ApixioRetryPolicy implements RetryPolicy
{
    private final static long baseSleep   = 100L;
    private final static long maxSleep    = 1000L;
    private final static int  attemptsMax = 10;

    private static Logger logger = LoggerFactory.getLogger(ApixioRetryPolicy.class);
    ...
    public ApixioRetryPolicy(int readAttempts, int writeAttempts, int unavailableAttempts, boolean downgrade)
    {
