...
@XmlSeeAlso({
    StructuredProductType.Product.Form.class,
    StructuredProductType.Product.Size.class,
    VehicleType.Product.Form.class,
    VehicleType.Product.Size.class,
    Direction.Route.class,
    SiteType.class,
    MethodType.class,
    PositionType.class,
